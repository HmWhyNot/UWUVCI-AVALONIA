...
using UWUVCI.Classes;
using UWUVCI.Properties;
using UWUVCI.UI;
using UWUVCI.UI.Frames.InjectFrames.Bases;
using UWUVCI.UI.Frames.InjectFrames.Configurations;
using UWUVCI.UI.Windows;
